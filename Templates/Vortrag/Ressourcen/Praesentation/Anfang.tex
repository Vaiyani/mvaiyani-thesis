    ...
    \setbeamertemplate{title page}{%
        ...
        \end{textblock*}
         \begin{textblock*}{\paperwidth}[0,0](0cm, -7.8mm)%
           \color{PraesentationTextfarbe}\fontsize{8pt}{10pt}\selectfont%
            \LehrstuhlName\\%
            \FakultaetName\\%
            \UniversitaetName\\%
            \normalcolor\normalsize\selectfont%
        \end{textblock*}%
                 \begin{textblock*}{\paperwidth}[0,0](0cm, 20mm)%
           \color{PraesentationTextfarbe}\fontsize{30pt}{30pt}\selectfont%
            \inserttitle
            \normalcolor\normalsize\selectfont%
        \end{textblock*}%
...
\newcommand{\PraesentationMasterKopfzeileDreizeiler}{
    ...
    \setbeamertemplate{headline}{
        \begin{textblock*}{\paperwidth}[0,0](0cm, -7.8mm)%
            \color{TUMBlau}\fontsize{8pt}{10pt}\selectfont%
            \LehrstuhlName\\%
            \FakultaetName\\%
            \UniversitaetName\\%
            \normalcolor\normalsize\selectfont%
...
\setbeamertemplate{frametitle}{%
    {\rule{0pt}{30mm}\fontsize{31}{\baselineskip}\selectfont\insertframetitle\newline}%\vspace*{-2mm}}%
}
